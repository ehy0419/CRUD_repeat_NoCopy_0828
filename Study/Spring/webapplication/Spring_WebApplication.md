...
### 웹 서버(Web Server)
![img.png](Spring_WebSever.png)

- HTTP 기반 동작
- **정적** 리소스 (정적 HTML, CSS, JS, 이미지, 영상) 제공

### 웹 어플리케이션 서버 (Web Application Server)
![img.png](Spring_WebApplicationServer.png)
...
![img.png](Spring_HelloServlet.png)
